...
function App() {
  ...
  // testing to see if get current weather and forecast
  // console.log(currentZipcodeWeather);
  // console.log(forecastZipcodeWeather);

  // previously had this in the return statement below
  /* <ZipcodeSearch onSearchZipcodeChange={handleOnZipcodeSearchChange} /> 
      {currentZipcodeWeather && <ActualWeather data={ currentZipcodeWeather}/>} */
